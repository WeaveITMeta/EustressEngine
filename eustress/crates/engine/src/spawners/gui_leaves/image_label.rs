//! `ImageLabelSpawner` — Wave 3.C GUI leaf.
//!
//! Non-interactive image display. See `text_label.rs` for the
//! structural pattern and CLASS_REGISTRY.md §8.6.

use bevy::prelude::*;
use eustress_common::class_registry::{
    ClassSpawner, ComponentBundle, LodTier, PropertyBag, RobloxInstance, SpawnCtx,
};
use eustress_common::classes::{ClassName, ImageLabel, Instance};

#[derive(Default)]
pub struct ImageLabelSpawner;

impl ClassSpawner for ImageLabelSpawner {
    ...
    fn spawn(&self, ctx: &mut SpawnCtx, props: &PropertyBag) -> Entity {
        ...
        ctx.commands
            .spawn((
                ...
                Instance {
                    name: name.clone(),
                    class_name: ClassName::ImageLabel,
                    archivable,
                    id: 0,
                    uuid,
                    ai: false,
