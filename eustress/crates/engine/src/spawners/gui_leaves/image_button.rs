//! `ImageButtonSpawner` — Wave 3.C GUI leaf.
//!
//! Clickable image. See `text_label.rs` for the structural pattern and
//! CLASS_REGISTRY.md §8.6.

use bevy::prelude::*;
use eustress_common::class_registry::{
    ClassSpawner, ComponentBundle, LodTier, PropertyBag, RobloxInstance, SpawnCtx,
};
use eustress_common::classes::{ClassName, ImageButton, Instance};

#[derive(Default)]
pub struct ImageButtonSpawner;

impl ClassSpawner for ImageButtonSpawner {
    ...
    fn spawn(&self, ctx: &mut SpawnCtx, props: &PropertyBag) -> Entity {
        ...
        ctx.commands
            .spawn((
                ...
                Instance {
                    name: name.clone(),
                    class_name: ClassName::ImageButton,
                    archivable,
                    id: 0,
                    uuid,
                    ai: false,
