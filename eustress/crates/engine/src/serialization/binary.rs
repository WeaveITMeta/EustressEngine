...
impl ClassId {
    pub fn from_class_name(name: ClassName) -> Self {
        match name {
            ...
            ClassName::Weld => ClassId::Instance,
            ClassName::Motor => ClassId::Instance,
            ClassName::VelocityMotor => ClassId::Instance,
            ClassName::NoCollisionConstraint => ClassId::Instance,
            ClassName::RigidConstraint => ClassId::Instance,
            ClassName::LineForce => ClassId::Instance,
            ClassName::AnimationConstraint => ClassId::Instance,
            // Wave 7.B UI layout modifiers
            ClassName::UICorner => ClassId::Instance,
            ClassName::UIGradient => ClassId::Instance,
            ClassName::UIStroke => ClassId::Instance,
            ClassName::UIListLayout => ClassId::Instance,
            ClassName::UIGridLayout => ClassId::Instance,
            ClassName::UIPadding => ClassId::Instance,
            ClassName::UIAspectRatioConstraint => ClassId::Instance,
            ClassName::UIScale => ClassId::Instance,
            ClassName::UISizeConstraint => ClassId::Instance,
            ClassName::UITextSizeConstraint => ClassId::Instance,
            ClassName::UITableLayout => ClassId::Instance,
            ClassName::UIPageLayout => ClassId::Instance,
            ClassName::UIFlexItem => ClassId::Instance,
            ClassName::CanvasGroup => ClassId::Instance,
            ...
            ClassName::MaterialVariant => ClassId::Instance,
            ClassName::Highlight => ClassId::Instance,
            ClassName::Bone => ClassId::Instance,
            ClassName::WrapDeformer => ClassId::Instance,
            ClassName::WrapLayer => ClassId::Instance,
            ClassName::WrapTarget => ClassId::Instance,
            // Wave 7.D character / players / animation
            ClassName::Animation => ClassId::Instance,
            ClassName::AnimationController => ClassId::Instance,
            ClassName::HumanoidController => ClassId::Instance,
            ClassName::ControllerManager => ClassId::Instance,
            ClassName::AirController => ClassId::Instance,
            ClassName::ClimbController => ClassId::Instance,
            ClassName::GroundController => ClassId::Instance,
            ClassName::SwimController => ClassId::Instance,
            ClassName::SkateboardController => ClassId::Instance,
            ClassName::VehicleController => ClassId::Instance,
            ClassName::ControllerPartSensor => ClassId::Instance,
            ClassName::HumanoidDescription => ClassId::Instance,
            ClassName::BodyPartDescription => ClassId::Instance,
            ClassName::Backpack => ClassId::Instance,
            ClassName::StarterGear => ClassId::Instance,
            ClassName::Accoutrement => ClassId::Instance,
            ClassName::AccessoryDescription => ClassId::Instance,
            ClassName::FaceControls => ClassId::Instance,
            ClassName::IKControl => ClassId::Instance,
            ClassName::KeyframeMarker => ClassId::Instance,
            ClassName::Pose => ClassId::Instance,
            ClassName::NumberPose => ClassId::Instance,
            ClassName::CurveAnimation => ClassId::Instance,
            ClassName::AnimationRigData => ClassId::Instance,
            // Wave 7.E audio DSP effects + routing
            ClassName::AudioReverb => ClassId::Instance,
            ClassName::AudioEcho => ClassId::Instance,
            ClassName::AudioDistortion => ClassId::Instance,
            ClassName::AudioEqualizer => ClassId::Instance,
            ClassName::AudioCompressor => ClassId::Instance,
            ClassName::AudioChorus => ClassId::Instance,
            ClassName::AudioFlanger => ClassId::Instance,
            ClassName::AudioFader => ClassId::Instance,
            ClassName::AudioFilter => ClassId::Instance,
            ClassName::AudioPitchShifter => ClassId::Instance,
            ClassName::AudioEmitter => ClassId::Instance,
            ClassName::AudioListener => ClassId::Instance,
            ClassName::AudioPlayer => ClassId::Instance,
            ClassName::AudioDeviceInput => ClassId::Instance,
            ClassName::AudioDeviceOutput => ClassId::Instance,
            ClassName::AudioAnalyzer => ClassId::Instance,
            ClassName::AudioSearchParams => ClassId::Instance,
            ClassName::ReverbSoundEffect => ClassId::Instance,
            ClassName::EchoSoundEffect => ClassId::Instance,
            ClassName::DistortionSoundEffect => ClassId::Instance,
            ClassName::EqualizerSoundEffect => ClassId::Instance,
            ClassName::CompressorSoundEffect => ClassId::Instance,
            ClassName::ChorusSoundEffect => ClassId::Instance,
            ClassName::FlangeSoundEffect => ClassId::Instance,
            ClassName::PitchShiftSoundEffect => ClassId::Instance,
            ClassName::TremoloSoundEffect => ClassId::Instance,
            // Wave 7.F data structs / curves / misc
            ClassName::DataStoreGetOptions => ClassId::Instance,
            ClassName::DataStoreSetOptions => ClassId::Instance,
            ClassName::DataStoreIncrementOptions => ClassId::Instance,
            ClassName::DataStoreOptions => ClassId::Instance,
            ClassName::FloatCurve => ClassId::Instance,
            ClassName::RotationCurve => ClassId::Instance,
            ClassName::EulerRotationCurve => ClassId::Instance,
            ClassName::Vector3Curve => ClassId::Instance,
            ClassName::MarkerCurve => ClassId::Instance,
            ClassName::Path2D => ClassId::Instance,
            ClassName::LocalizationTable => ClassId::Instance,
            ClassName::Configuration => ClassId::Instance,
            ClassName::Noise => ClassId::Instance,
            ClassName::UnreliableRemoteEvent => ClassId::Instance,
            ClassName::Wire => ClassId::Instance,
            ClassName::OperationGraph => ClassId::Instance,
            // Wave 7.G editable / sensors / chat
            ClassName::EditableImage => ClassId::Instance,
            ClassName::RobloxEditableImage => ClassId::Instance,
            ClassName::BuoyancySensor => ClassId::Instance,
            ClassName::DragDetector => ClassId::Instance,
            ClassName::TextChannel => ClassId::Instance,
