...
/// Eustress fork addition: real-time-friendly compaction wrapper that
/// caps single-compaction size so a background merge cannot stall.
pub use budgeted::Strategy as Budgeted;
/// Eustress fork addition: 3D-locality-preserving compaction wrapper
/// that co-locates key-adjacent (Morton-adjacent) segments in idle
/// gaps without overriding the inner strategy's decisions.
pub use locality::Strategy as Locality;
